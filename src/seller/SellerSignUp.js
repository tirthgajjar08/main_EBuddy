...
function SellerSignUp() {
    ...
    const handleSubmit = (event) => {
        ...
        if (SignupValidation(values)) {
            fetch(`http://localhost:3032/seller`, {
                method: "POST",
           ...
           <div className="container login-box-style">
                <div className="row">
                    <div className="col-lg 6">
                        <div className="image">
                            <img src="images/login.gif" alt=""></img>
                        </div>
                    </div>
                    ...
                    <div className="col-lg 6 mt-5">
                        ...
                        <div className="form-group mt-4">
                            ...
                            <div className="form-group mt-4">
<label for="id">Enter your GSTIN</label>
<input type="text" name="id" className="form-control  login_text_box" value={values.id} onChange={handleChange} placeholder="your gstin name" />
{errorMsg && values.id.length <= 0 ? <p id="addressAuth" style={{ color: "red" }}>GSTNumber is Required</p> : ""}
</div>
                            ...
                            <div className='text2'>
            <p className="mt-4" style={{width:"77%",color:"gray"}}>GSTIN is required to sell products on EBuddy. You can also share it in the final step.</p>
        </div>
                            <div className="mt-4">
                                <button type="submit"  className="login_button_style mb-5">Register & Continue</button>
                            </div>
