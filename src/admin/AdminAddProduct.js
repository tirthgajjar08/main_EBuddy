                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <input type="text" autoComplete="off" class="form-control" name="product_mrpprice" value={prodcutsValue.product_mrpprice} onChange={handleChange} />
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <input type="text" autoComplete="off" class="form-control" name="product_price" value={prodcutsValue.product_price} onChange={handleChange} />
